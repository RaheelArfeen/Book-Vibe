...
const BookDetails = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Book Details - {singleBook.bookName}</title>
      </Helmet>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden lg:flex flex-col md:flex-row">
            ...
            <div className="p-8 md:p-12 w-full">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600">{singleBook.review}</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="px-6 py-2 bg-white border-2 border-gray-900 text-gray-900 cursor-pointer rounded-md font-semibold hover:bg-gray-100 transition-colors"
                >
                  Mark as Read
                </button>
                <button
                  onClick={() => handleMarkAsWish(id)}
                  className="px-6 py-2 bg-sky-400 text-white rounded-md font-semibold hover:bg-sky-500 transition-colors cursor-pointer"
                >
                  Add to Wishlist
                </button>
                <a
                  href="/"
                  className="px-6 py-2 bg-green-500 text-white rounded-md font-semibold hover:bg-green-600 cursor-pointer transition-colors text-center"
                >
                  Go Back
                </a>
              </div>
